...
export RESULT_DIR=$RESULT_BASE_DIR/bfs-web
export CMD_SCRIPT_PATH=$PRIVATE_POND_DIR/gapbs/bfs-web
...
# Find the PID of the 'bfs' process based on its name, selecting the last one
bc_pid=$(pgrep -f "bfs" | tail -n 1)
