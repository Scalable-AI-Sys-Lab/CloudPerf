...
base_dir = '../results/dlrm'  # Use the current directory

# Specify the output Excel file
output_file = 'interference_dlrm_llama.xlsx'
...
dir_names = ["dlrm_rm1_high", "dlrm_rm1_low", "dlrm_rm1_med", "dlrm_rm2_1_high", "dlrm_rm2_1_low", "dlrm_rm2_1_med"]
