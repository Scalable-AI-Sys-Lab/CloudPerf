...
file_paths = {
    "tpch": {
        "vectordb_contention_file": "../tpch_commands/contention_tpch_vector.xlsx",
        "workload_contention_file": "../tpch_commands/contention_tpch_workload.xlsx",
        "workload_single_summary": "../tpch_commands/tpch_single_summary_20G.xlsx",
...
output_file = 'memory_contention.xlsx'
new_output_file = 'memory_contention.xlsx'
