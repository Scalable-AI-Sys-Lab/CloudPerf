...
# attention, this line in the workloade is different
...
python3 ./bin/ycsb load redis -s -P workloads/workloade -p "redis.host=127.0.0.1" -p "redis.port=6379" -p "threadcount=3"
