...
# check the output dir name!!!


# Output file name
output_file = 'kv_store_single_summary_20G.xlsx'


# Number of latest entries to store
NUM_LAST_ENTRIES = 1  # Default value, can be changed dynamically
