...
cd ../../YCSB
export RESULT_DIR=../results/kv_store/redis_ycsb_d
...
python3 ./bin/ycsb run redis -s -P workloads/workloadd -p "redis.host=127.0.0.1" -p "redis.port=6379" -p "threadcount=3" >> $RESULT_DIR/result_app_perf.txt 2>> $RESULT_DIR/result_app_perf.txt
