...
export RESULT_DIR=/data/Mercury_workloads/results/kv_store/FASTER_UNIFORM_B

mkdir -p $RESULT_DIR

cd $FASTER_DIR
# the paramater 60 here specifies the running time
/usr/bin/time -pao $RESULT_DIR/result_time.txt ./pmem_benchmark 1 1 1 0 8000000 1000000000000000 0 60 >> $RESULT_DIR/result_app_perf.txt 2>> $RESULT_DIR/result_app_perf.txt &
