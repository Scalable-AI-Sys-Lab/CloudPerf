...
export RESULT_DIR=../../../../results/kv_store/faster_ycsb_c
mkdir -p $RESULT_DIR
...
/usr/bin/time -pao $RESULT_DIR/result_time.txt ./pmem_benchmark 2 1 1 0.99 8000000 1000000000000000 0 60 >> $RESULT_DIR/result_app_perf.txt 2>> $RESULT_DIR/result_app_perf.txt
