...
export RESULT_DIR=$BASE_KV_RESULT_DIR/memcached_ycsb_b
...
python3 ./bin/ycsb run memcached -s -P ./workloads/workloadb -p "memcached.hosts=127.0.0.1" -p "threadcount=2" >> $RESULT_DIR/result_app_perf.txt 2>> $RESULT_DIR/result_app_perf.txt
