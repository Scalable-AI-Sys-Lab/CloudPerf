...
# cd YCSB
sed -i 's/recordcount=.*/recordcount=5000000/' $YCSB_DIR/workloads/workloadd
sed -i 's/operationcount=.*/operationcount=5000000/' $YCSB_DIR/workloads/workloadd
sed -i 's/requestdistribution=.*/requestdistribution=zipfian/' $YCSB_DIR/workloads/workloadd
...
cd $YCSB_DIR
# insert data
python3 ./bin/ycsb load memcached -s -P ./workloads/workloadd -p "memcached.hosts=127.0.0.1" -p "threadcount=2"
