...
# cd YCSB
sed -i 's/recordcount=.*/recordcount=5000000/' $YCSB_DIR/workloads/workloadc
sed -i 's/operationcount=.*/operationcount=5000000/' $YCSB_DIR/workloads/workloadc
sed -i 's/requestdistribution=.*/requestdistribution=zipfian/' $YCSB_DIR/workloads/workloadc
...
cd $YCSB_DIR
# insert data
python3 ./bin/ycsb load memcached -s -P ./workloads/workloadc -p "memcached.hosts=127.0.0.1" -p "threadcount=2"
