...
base_dir = '../results/spark'  # Use the current directory

# Specify the output Excel file
output_file = 'interference_spark_llama_new.xlsx'
...
dir_names = ["spark_als", "spark_gbt", "spark_sort", "spark_wordcount", "spark_pca", "spark_rf", "spark_terasort", "spark_linear"]
